...
# Sample key_blob_name : sa_key/gen-ai-4all-8cf2714638bc.json stored in Github secrets. 
# The JSON file is uploaded to the bucket ccai_gemini_datagen/sa_key
# The key expires every 3 months, go into IAM and create a new key
